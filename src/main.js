...
export default handle=()=>{
    const terminal=findDOMNode(this.refs.mainRef)
        $(terminal).ready(function($) 
        {
            ...
            $('body').terminal({
                ...
                contribute: function() {
                    ...
                    this.echo('> Link: <https://github.com/imabp/LearnBasicLinuxTerminal>\n');
                },
                about: function() {
                    ...
                    this.echo("> I'm [[b;#44D544;]Abir Pal], a computer science undergrad at Chandigarh University. \n I love to develop Applications. Currently I am [[b;#44D544;]SDE intern WKND], a London based Startup and [[b;#44D544;]QX Research, Mozilla]");
                },
            }, {
